...
func TestParseQueryParams(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := models.ParseQueryParams(params)

			if !reflect.DeepEqual(result, tt.expected) {
				t.Errorf("models.ParseQueryParams() = %+v, want %+v", result, tt.expected)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if result != tt.expected {
				t.Errorf("models.Filter.MatchesResourcePool() = %v, want %v", result, tt.expected)
			}
		})
	}
}
...
func TestFilter_MatchesResource(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if result != tt.expected {
				t.Errorf("models.Filter.MatchesResource() = %v, want %v", result, tt.expected)
			}
		})
	}
}
...
func TestFilter_MatchesResourceType(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if result != tt.expected {
				t.Errorf("models.Filter.MatchesResourceType() = %v, want %v", result, tt.expected)
			}
		})
	}
}
...
func TestFilter_MatchesSubscription(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if result != tt.expected {
				t.Errorf("models.Filter.MatchesSubscription() = %v, want %v", result, tt.expected)
			}
		})
	}
}
...
func TestFilter_IsEmpty(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if result != tt.expected {
				t.Errorf("models.Filter.IsEmpty() = %v, want %v", result, tt.expected)
			}
		})
	}
}
...
func Test_Contains(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := models.Contains(tt.slice, tt.item)
			if result != tt.expected {
				t.Errorf("models.Contains() = %v, want %v", result, tt.expected)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !reflect.DeepEqual(filter.Fields, tt.expectedFields) {
				t.Errorf("models.ParseQueryParams().Fields = %v, want %v", filter.Fields, tt.expectedFields)
			}
		})
	}
}
...
func TestFilter_HasFieldSelection(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if result != tt.expected {
				t.Errorf("models.Filter.HasFieldSelection() = %v, want %v", result, tt.expected)
			}
		})
	}
}
...
func TestFilter_ShouldIncludeField(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if result != tt.expected {
				t.Errorf("models.Filter.ShouldIncludeField(%q) = %v, want %v", tt.fieldName, result, tt.expected)
			}
		})
	}
}
...
func TestFilter_SelectFields(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !reflect.DeepEqual(result, tt.expected) {
				t.Errorf("models.Filter.SelectFields() = %v, want %v", result, tt.expected)
			}
		})
	}
}
