...
func (a *Adapter) ListResourcePools(_ context.Context, filter *adapter.Filter) ([]*adapter.ResourcePool, error) {
	a.mu.RLock()
	defer a.mu.RUnlock()
...
func (a *Adapter) ListResources(_ context.Context, filter *adapter.Filter) ([]*adapter.Resource, error) {
	a.mu.RLock()
	defer a.mu.RUnlock()
...
func (a *Adapter) UpdateResource(_ context.Context, id string, resource *adapter.Resource) (*adapter.Resource, error) {
	a.mu.Lock()
	defer a.mu.Unlock()
...
func (a *Adapter) ListResourceTypes(_ context.Context, filter *adapter.Filter) ([]*adapter.ResourceType, error) {
	a.mu.RLock()
	defer a.mu.RUnlock()
